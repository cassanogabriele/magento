...
--
-- Structure de la table `msh_directory_country_region_name`
--

CREATE TABLE `msh_directory_country_region_name` (
...
--
-- Contenu de la table `msh_directory_country_region_name`
--

INSERT INTO `msh_directory_country_region_name` (`locale`, `region_id`, `name`) VALUES
('en_US', 1, 'Alabama'),
('en_US', 2, 'Alaska'),
...
--
-- Index pour la table `msh_directory_country_region_name`
--
ALTER TABLE `msh_directory_country_region_name`
  ADD PRIMARY KEY (`locale`,`region_id`),
  ADD KEY `MSH_DIRECTORY_COUNTRY_REGION_NAME_REGION_ID` (`region_id`);
...
--
-- Contraintes pour la table `msh_directory_country_region_name`
--
ALTER TABLE `msh_directory_country_region_name`
  ADD CONSTRAINT `FK_7EDFB0F2A1C077E1F235B8A45B23F2B7` FOREIGN KEY (`region_id`) REFERENCES `msh_directory_country_region` (`region_id`) ON DELETE CASCADE;
