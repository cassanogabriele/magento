...
--
-- Structure de la table `msh_sales_order_item`
--

CREATE TABLE `msh_sales_order_item` (
...
--
-- Index pour la table `msh_sales_order_item`
--
ALTER TABLE `msh_sales_order_item`
  ADD PRIMARY KEY (`item_id`),
  ADD KEY `MSH_SALES_ORDER_ITEM_ORDER_ID` (`order_id`),
  ADD KEY `MSH_SALES_ORDER_ITEM_STORE_ID` (`store_id`);
...
--
-- AUTO_INCREMENT pour la table `msh_sales_order_item`
--
ALTER TABLE `msh_sales_order_item`
...
--
-- Contraintes pour la table `msh_sales_order_item`
--
ALTER TABLE `msh_sales_order_item`
  ADD CONSTRAINT `MSH_SALES_ORDER_ITEM_ORDER_ID_SALES_ORDER_ENTITY_ID` FOREIGN KEY (`order_id`) REFERENCES `msh_sales_order` (`entity_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `MSH_SALES_ORDER_ITEM_STORE_ID_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `msh_store` (`store_id`) ON DELETE SET NULL;
