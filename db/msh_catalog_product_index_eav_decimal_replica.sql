...
--
-- Structure de la table `msh_catalog_product_index_eav_decimal_replica`
--

CREATE TABLE `msh_catalog_product_index_eav_decimal_replica` (
...
--
-- Index pour la table `msh_catalog_product_index_eav_decimal_replica`
--
ALTER TABLE `msh_catalog_product_index_eav_decimal_replica`
