...
--
-- Structure de la table `msh_directory_country_region`
--

CREATE TABLE `msh_directory_country_region` (
...
--
-- Contenu de la table `msh_directory_country_region`
--

INSERT INTO `msh_directory_country_region` (`region_id`, `country_id`, `code`, `default_name`) VALUES
(1, 'US', 'AL', 'Alabama'),
(2, 'US', 'AK', 'Alaska'),
...
--
-- Index pour la table `msh_directory_country_region`
--
ALTER TABLE `msh_directory_country_region`
  ADD PRIMARY KEY (`region_id`),
  ADD KEY `MSH_DIRECTORY_COUNTRY_REGION_COUNTRY_ID` (`country_id`);
...
--
-- AUTO_INCREMENT pour la table `msh_directory_country_region`
--
ALTER TABLE `msh_directory_country_region`
  MODIFY `region_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Region Id', AUTO_INCREMENT=569;
