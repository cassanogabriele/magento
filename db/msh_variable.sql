...
--
-- Structure de la table `msh_variable`
--

CREATE TABLE `msh_variable` (
...
--
-- Index pour la table `msh_variable`
--
ALTER TABLE `msh_variable`
  ADD PRIMARY KEY (`variable_id`),
  ADD UNIQUE KEY `MSH_VARIABLE_CODE` (`code`);
...
--
-- AUTO_INCREMENT pour la table `msh_variable`
--
ALTER TABLE `msh_variable`
