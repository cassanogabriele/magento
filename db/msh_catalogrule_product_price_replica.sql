...
--
-- Structure de la table `msh_catalogrule_product_price_replica`
--

CREATE TABLE `msh_catalogrule_product_price_replica` (
...
--
-- Index pour la table `msh_catalogrule_product_price_replica`
--
ALTER TABLE `msh_catalogrule_product_price_replica`
...
--
-- AUTO_INCREMENT pour la table `msh_catalogrule_product_price_replica`
--
ALTER TABLE `msh_catalogrule_product_price_replica`
