...
--
-- Structure de la table `msh_cataloginventory_stock_status_replica`
--

CREATE TABLE `msh_cataloginventory_stock_status_replica` (
...
--
-- Index pour la table `msh_cataloginventory_stock_status_replica`
--
ALTER TABLE `msh_cataloginventory_stock_status_replica`
