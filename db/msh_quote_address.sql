...
--
-- Structure de la table `msh_quote_address`
--

CREATE TABLE `msh_quote_address` (
...
--
-- Index pour la table `msh_quote_address`
--
ALTER TABLE `msh_quote_address`
  ADD PRIMARY KEY (`address_id`),
  ADD KEY `MSH_QUOTE_ADDRESS_QUOTE_ID` (`quote_id`);
...
--
-- AUTO_INCREMENT pour la table `msh_quote_address`
--
ALTER TABLE `msh_quote_address`
...
--
-- Contraintes pour la table `msh_quote_address`
--
ALTER TABLE `msh_quote_address`
  ADD CONSTRAINT `MSH_QUOTE_ADDRESS_QUOTE_ID_QUOTE_ENTITY_ID` FOREIGN KEY (`quote_id`) REFERENCES `msh_quote` (`entity_id`) ON DELETE CASCADE;
