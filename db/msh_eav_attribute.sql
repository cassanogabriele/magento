...
--
-- Structure de la table `msh_eav_attribute`
--

CREATE TABLE `msh_eav_attribute` (
...
--
-- Contenu de la table `msh_eav_attribute`
--

INSERT INTO `msh_eav_attribute` (`attribute_id`, `entity_type_id`, `attribute_code`, `attribute_model`, `backend_model`, `backend_type`, `backend_table`, `frontend_model`, `frontend_input`, `frontend_label`, `frontend_class`, `source_model`, `is_required`, `is_user_defined`, `default_value`, `is_unique`, `note`) VALUES
...
--
-- Index pour la table `msh_eav_attribute`
--
ALTER TABLE `msh_eav_attribute`
  ADD PRIMARY KEY (`attribute_id`),
  ADD UNIQUE KEY `MSH_EAV_ATTRIBUTE_ENTITY_TYPE_ID_ATTRIBUTE_CODE` (`entity_type_id`,`attribute_code`);
...
--
-- AUTO_INCREMENT pour la table `msh_eav_attribute`
--
ALTER TABLE `msh_eav_attribute`
...
--
-- Contraintes pour la table `msh_eav_attribute`
--
ALTER TABLE `msh_eav_attribute`
  ADD CONSTRAINT `MSH_EAV_ATTRIBUTE_ENTITY_TYPE_ID_EAV_ENTITY_TYPE_ENTITY_TYPE_ID` FOREIGN KEY (`entity_type_id`) REFERENCES `msh_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE;
