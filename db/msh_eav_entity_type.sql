...
--
-- Structure de la table `msh_eav_entity_type`
--

CREATE TABLE `msh_eav_entity_type` (
...
--
-- Contenu de la table `msh_eav_entity_type`
--

INSERT INTO `msh_eav_entity_type` (`entity_type_id`, `entity_type_code`, `entity_model`, `attribute_model`, `entity_table`, `value_table_prefix`, `entity_id_field`, `is_data_sharing`, `data_sharing_key`, `default_attribute_set_id`, `increment_model`, `increment_per_store`, `increment_pad_length`, `increment_pad_char`, `additional_attribute_table`, `entity_attribute_collection`) VALUES
...
--
-- Index pour la table `msh_eav_entity_type`
--
ALTER TABLE `msh_eav_entity_type`
  ADD PRIMARY KEY (`entity_type_id`),
  ADD KEY `MSH_EAV_ENTITY_TYPE_ENTITY_TYPE_CODE` (`entity_type_code`);
...
--
-- AUTO_INCREMENT pour la table `msh_eav_entity_type`
--
ALTER TABLE `msh_eav_entity_type`
