...
--
-- Structure de la table `msh_catalogrule_product`
--

CREATE TABLE `msh_catalogrule_product` (
...
--
-- Index pour la table `msh_catalogrule_product`
--
ALTER TABLE `msh_catalogrule_product`
...
--
-- AUTO_INCREMENT pour la table `msh_catalogrule_product`
--
ALTER TABLE `msh_catalogrule_product`
