...
--
-- Structure de la table `msh_catalogrule_group_website`
--

CREATE TABLE `msh_catalogrule_group_website` (
...
--
-- Index pour la table `msh_catalogrule_group_website`
--
ALTER TABLE `msh_catalogrule_group_website`
