...
--
-- Structure de la table `msh_catalogsearch_fulltext_scope1`
--

CREATE TABLE `msh_catalogsearch_fulltext_scope1` (
  `entity_id` int(10) UNSIGNED NOT NULL COMMENT 'Entity ID',
  `attribute_id` int(10) UNSIGNED NOT NULL COMMENT 'Attribute_id',
  `data_index` longtext COMMENT 'Data index'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='msh_catalogsearch_fulltext_scope1_tmp';

--
-- Contenu de la table `msh_catalogsearch_fulltext_scope1`
--

INSERT INTO `msh_catalogsearch_fulltext_scope1` (`entity_id`, `attribute_id`, `data_index`) VALUES
...
--
-- Index pour la table `msh_catalogsearch_fulltext_scope1`
--
ALTER TABLE `msh_catalogsearch_fulltext_scope1`
  ADD PRIMARY KEY (`entity_id`,`attribute_id`);
ALTER TABLE `msh_catalogsearch_fulltext_scope1` ADD FULLTEXT KEY `FTI_FULLTEXT_DATA_INDEX` (`data_index`);
